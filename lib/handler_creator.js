      ...
      return {
        ...
        beforeModel: function (transition) {
          ...
          return Promise.resolve(handler.route || createRoute(name)).then(function (route) {
            ...
            // reset the context with each transition
            route.setContext({});
         ...
         * proxy to route.model and reset the context
         */
        model: function (params) {
          ...
          return Promise.resolve(this.route.model.apply(this.route, arguments)).then(function (context) {
            return resolveKeys(context);
