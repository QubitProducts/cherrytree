 ...
 */
Cherrytree.prototype.initialize = function (routes, options, middleware) {
  // options is optional
  if (!isObject(options) && !middleware) {
    middleware = options
  }
...
export default function cherrytree (routes, options, middleware) {
  return new Cherrytree(routes, options, middleware)
}
