  ...
  define(function (require) {
    ...
    function makeHandler(router, routeCreator, name) {
      return {
         ...
         * loading some extra code in (which happens in the routeCreator).
        ...
        beforeModel: function (transition) {
          var handler = this;
          return RSVP.resolve(handler.route || routeCreator.createRoute(name)).then(function (route) {
        ...
        events: {
          ...
          // queryParamsDidChange: function (changed, all) {
            // this.setup(null, null, all);
            // _.each(changed, function (val, queryParam) {
            //   if (_.has(this.params.queryParams, queryParam)) {
            //     this.refresh();
            //   }
            // }, this);
            // this.router.router.refresh(this);
          //   return false;
          // }
        },
