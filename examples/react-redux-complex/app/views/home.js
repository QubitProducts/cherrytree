      ...
      <div className='Home'>
        ...
        <div className='Tweet'>
          <div className='Tweet-author'>
            <a href={href({ route: 'profile.index', params: { user: 'dan_abramov' } })}>Dan Abramov ‏@dan_abramov</a>
          </div>
        ...
        <div className='Tweet'>
          <div className='Tweet-author'>
            <a href={href({ route: 'profile.index', params: {user: 'afanasjevas'} })}>Eduardas Afanasjevas ‏@afanasjevas</a>
          </div>
          <div className='Tweet-time'>12m12 minutes ago</div>
        ...
        <div className='Tweet'>
          <div className='Tweet-author'>
            <a href={href({ route: 'profile.index', params: {user: 'LNUGorg'} })}>LNUG ‏@LNUGorg</a>
          </div>
