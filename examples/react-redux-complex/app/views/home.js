      ...
      <div className='Home'>
        ...
        <div className='Tweet'>
          <div className='Tweet-author'>
            <a href={this.context.router.href('profile.index', {user: 'dan_abramov'})}>Dan Abramov ‏@dan_abramov</a>
          </div>
        ...
        <div className='Tweet'>
          <div className='Tweet-author'>
            <a href={this.context.router.href('profile.index', {user: 'afanasjevas'})}>Eduardas Afanasjevas ‏@afanasjevas</a>
          </div>
          <div className='Tweet-time'>12m12 minutes ago</div>
        ...
        <div className='Tweet'>
          <div className='Tweet-author'>
            <a href={this.context.router.href('profile.index', {user: 'LNUGorg'})}>LNUG ‏@LNUGorg</a>
          </div>
